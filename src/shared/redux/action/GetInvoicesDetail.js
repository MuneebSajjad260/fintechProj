...
export const GetInvoicesDetail = createAsyncThunk(
  'getInvoicesDetail/GetInvoicesDetail',
  async (id, thunkAPI) => {
    const endpointName = '(Invoices Details)';
    ...
    try {
      ...
      const response = await instance.get(
        `${API_ENDPOINTS.fintech_backend_url}/customer-invoices/${id}`,
      );
